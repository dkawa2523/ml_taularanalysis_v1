...
def plot_feature_importance(
    ...
    *,
    ...
    if plt is None:
        _render_placeholder(path, title or "Feature Importance")
        return path
...
def plot_regression_residuals(
    ...
    *,
    ...
    path = _as_path(output_path)
    if plt is None:
        _render_placeholder(path, title or "Residuals vs Predicted")
        return path
...
def plot_interval_width_histogram(
    ...
    *,
    ...
    path = _as_path(output_path)
    if plt is None:
        _render_placeholder(path, title or "Interval Widths")
        return path
...
def plot_confusion_matrix(
    ...
    *,
    ...
    if plt is None:
        _render_placeholder(
            path,
            title or ("Confusion Matrix (normalized)" if normalize else "Confusion Matrix"),
        )
        return path
...
def plot_reliability_curve(
    ...
    *,
    ...
    path = _as_path(output_path)
    if plt is None:
        _render_placeholder(path, title or "Reliability Diagram")
        return path
...
def plot_roc_curve(
    ...
    *,
    ...
    path = _as_path(output_path)
    if plt is None:
        _render_placeholder(path, title or "ROC Curve")
        return path
