"""Plotly visuals for infer outputs."""
...
def build_input_output_table(
    ...
    *,
    ...
    go = _plotly_go()
    if go is None:
        return _fallback_image(output_path, title)
...
def build_prediction_histogram(
    values: Sequence[Any],
    *,
